...
| ResNet+LSTM (Optuna) | 256.7 ±60.2 | 0.375 ±0.146 | 2/4 |
...
| GraphSAGE+LSTM (Optuna) | 208.8 | 0.631 | 1/4 |
...
| ResNet+LSTM (Optuna) | 258.0 ±2.0 | 0.363 ±0.005 | 3/4 |
| GraphSAGE+LSTM (Optuna) | 252.1 ±2.4 | 0.378 ±0.006 | 2/4 |

### 6 h

| Model | RMSE_day (W/m²) | Skill_day | Seeds |
|---|---|---|---|
| Persistence | 469.9 | 0.000 | — |
| ResNet+LSTM | 284.5 ±19.5 | 0.393 ±0.048 | 5/5 ✓ |
| GraphSAGE+LSTM | 274.2 ±5.1 | 0.418 ±0.011 | 5/5 ✓ |
| GraphSAGE+LSTM (Optuna) | 269.5 | 0.428 | 1/4 |
