...
| ResNet+LSTM (Optuna v2) | 230.4 ±6.4 | -0.127 ±0.031 | 4/4 ✓ |
...
| ResNet+LSTM (Optuna v2) | 245.9 ±19.7 | 0.402 ±0.048 | 3/4 |
...
| ResNet+LSTM (Optuna v2) | 208.6 | 0.631 | 1/4 |
...
| ResNet+LSTM (Optuna v2) | 257.6 ±17.1 | 0.124 ±0.058 | 4/4 ✓ |
| GraphSAGE+LSTM (Optuna v2) | 250.5 | 0.148 | 1/4 |
...
| ResNet+LSTM (Optuna v2) | 259.1 ±10.9 | 0.360 ±0.027 | 4/4 ✓ |
