...
reconstrucción de El Paso): ResNet 12/12, GraphSAGE 10/12, MLP 5/12
combinaciones. \emph{Hallazgo a revisar antes de reportar:} GraphSAGE a 1h
colapsa a varianza casi constante (homoscedástica) en 3 de 4 semillas --- el
modo de fallo conocido de las redes de varianza, probablemente porque a ese
horizonte el residuo de GraphSAGE tiene poca señal explotable (su skill de
punto también es el más débil ahí). No bloquea, pero conviene mirarlo (¿lr o
épocas distintas para la red de varianza?).
