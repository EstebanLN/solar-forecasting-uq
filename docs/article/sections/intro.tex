...
\begin{enumerate}
  ...
  \item We introduce an \textbf{epistemic uncertainty-quantification layer}
        ...
        which quantifies uncertainty due to limited or atypical training
        data and finite model capacity \cite{kendall2017}. Unlike a single
        symmetric prediction interval, this signal tells an operator
        \emph{when} a forecast was produced under conditions the model has
        not adequately learned, supporting a conservative fallback or
        flagging the forecast for prioritised retraining, rather than
