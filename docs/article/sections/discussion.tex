...
\begin{itemize}
  \item For \textbf{El~Paso-type sites} (high irradiance, moderate variability),
        ...
        at 3h and 6h horizons, reducing RMSE over persistence by approximately
        42\% at 3h and over 60\% at 6h. At 1h, the system should fall back to
  ...
  \item The high seed variance of ResNet-LSTM at El~Paso 3h ($\pm 0.104$) suggests
...
work is that knowing \emph{whether the model itself is confident} in a
forecast is operationally valuable, independent of the width of any
interval.
