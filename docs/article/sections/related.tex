...
requires several hours of spin-up time \cite{perez2010}.
...
\cite{acikgoz2022,paletta2021,feng2022}. The encoder-decoder design, where a CNN
...
Attention-based architectures, including transformer-based temporal fusion
models, have also been applied to satellite-based solar forecasting
\cite{liu2023}, achieving competitive performance at the cost of increased
parameter count and data requirements. For moderate dataset sizes such
...
It has been applied to traffic forecasting \cite{li2018} and other
spatially-structured prediction tasks where proximity defines the graph
topology. In the context of satellite imagery, representing pixels as graph
...
Closest to our work, \citet{ji2022} applied a GNN-LSTM model to multi-site solar
...
deployment. Nevertheless, GNN-based solar forecasting studies to date --- including
our closest comparator --- have been validated exclusively in temperate or
station-network settings, leaving open whether these architectural advantages
transfer to a single-patch, tropical-mountain regime with fundamentally
different cloud dynamics.
...
(Europe, southwestern United States, Australia) \cite{paletta2022,yang2018}.
...
variability concentrated in the afternoon \cite{poveda2014}. Few published studies
address satellite-based forecasting for Colombian or equivalent tropical mountain
conditions, motivating the architectural comparison undertaken in
Sections~\ref{sec:methodology}--\ref{sec:results}.
...
of accommodating variable renewable generation. For
...
predictive uncertainty in this way. \citet{kendall2017} formalise the aleatoric/epistemic split for
