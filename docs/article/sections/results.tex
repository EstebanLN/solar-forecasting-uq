...
$\skillday = 0.401$, above ResNet-LSTM ($0.368$) and just below
...
\begin{table*}[t]
  ...
  \begin{tabular}{llcccccc}
    ...
    \midrule
    \multirow{2}{*}{FlatMLP}
      & $\rmseday$ & --- & --- & --- & $271.2 \pm 13.0$ & $275.5 \pm 5.6$ & $282.0 \pm 2.0$ \\
      & $\skillday$ & --- & --- & --- & $+0.077 \pm 0.044$ & $+0.320 \pm 0.014$ & $+0.401 \pm 0.004$ \\
    \bottomrule
  \end{tabular}}
  \par\smallskip
  ...
  (spatial average-pool, no spatial structure) --- is populated for Uniandes
  (four seeds at 1h/3h, three at 6h); its El~Paso row awaits the corrected
