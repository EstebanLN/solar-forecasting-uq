...
\begin{tikzpicture}[node distance=8mm]
  ...
  \draw[flow] (spatialenc.east) -| (sum.north)
    node[dimlabel, pos=0.75, right, xshift=1mm] {$e_\ell$};
  \draw[flow] (tabproj.east) -| (sum.south)
    node[dimlabel, pos=0.9, right, xshift=1mm] {$p_\ell$};
  ...
  \node[dimlabel, below=13mm of sum, xshift=14mm] {residual sum,\\ same embedding space};
