...
\begin{tikzpicture}[node distance=8mm]
  ...
  % ==================================================================
  \node[inputblock, below=20mm of input1, text width=2.6cm] (input2)
  ...
  % ==================================================================
  \node[sumnode] (sum) at ($(spatialenc.east)+(13mm,-10mm)$) {$+$};
  ...
  \node[dimlabel, above=6mm of sum] {residual sum,\\ same embedding space};
